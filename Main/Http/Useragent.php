<?php
/**
 * Random browser user agent class
 * @package creoLAB/Main
...
class Creo_Http_Useragent
{
	...
	*/
	public static function getRandomUserAgent(){
		...
		foreach($this->frequency as $k=>$v) $max += $v;
		$roll = rand(0,$max);
		foreach($this->frequency as $k=>$v) if (($roll <= ($rcount += $v)) and (!$browser_type)) $browser_type = $k;
		$user_agent_array = $this->browserSettings[$browser_type];
